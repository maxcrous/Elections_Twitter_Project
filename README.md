...
- **Gender identification.** Whose used twitter most during the elections, men or women? What are the differences in candidate preference and twitter behavior between men and women. 
...
- **Visibility:** How visible were the candidates on twitter, i.e., what is the total number of hashtags and @'s that refer to a specific candidate. 
- **Love or rage?** What is the total amount of positive/negative tweets?
- News Agencies. What is the percentage of tweets that originate from news agencies. How does this compare to the tweets originating from normal users. 
